...
Important TL;DR
Athletes Preperation
Scope

Standard Principles
Simulation Protocols
Heat Protocols
Proximity to Judging Booth / Beach Marshall
...
The running principles aim to emulate as specifically as possible the rulebooks of the ISA(Internation Surf Assocation) and the WSL.

Principles from those rulebooks are assumed true, unless otherwise stated within the simulation rulebook. The ISA rulebook will take precedent over the WSL equivalent when there are conflicting principles.

Each athlete is expected to read the entire document and fully understand the purpose of the training, the format, the scheduling and the rules.

Understand how to navigate the document to find all relevant information such as 'Athletes Code of Conduct', the schedule and draw, and the scores of each heat. Have immediate access to the link to the document, and have the google sheets app downloaded.

Each athlete is expected to undertake each next step with speed, maintain alertness, understand when their next heat is, and keep in mind that they are taking the role of an athlete and thus are adopting the associate values of being an athlete

Each athlete must return the jersey to the beach marshal bucket immediately after each heat. They must collect their next jersey as quickly as possible, and choose a different colour to the previous heat.
...
Immediate access to the simulator document with an understanding of its layout and how to navigate it.

Full understanding of everything set out in the document and rulebook.

Consider arriving before checkin to be fully prepared and to do a thorough and individualized warmup surf.
...
The goal of contest simulation is to create high density exposure to the reality of a contest environment. And to do so for all skill levels, ranging from initial club entry, to National, to ISA Games and to WSL Tours.
...
Return to beach marshall ASAP and return the jersey
If your heat is next, checkin and state your new jersey colour
...
JUDGING BOOTH PROXIMITY

Results, scores and evoling draws can be read from the draw spreadsheet
...
Major maneuvers are the backbone of increasing your scores. One single maneuvre brings a score into the excellent range.



SCORING PARITY FACTORS

Scoring parity is an evolving concept and will be refined objectively as time evolves.

Depeding on the event, a scoring parity will be applied in a degree which correlates to the division and the surfers
...
If they perform better than the highest placing athlete in the division 2 final, they may recieve enough points to equalize their overall placing on the points leaderboard with that athlete
...
Bonus Heats will reward extra points to an athletes overal stack of event points.
...
Give my teammates positive input and feedback.
Compete fairly.
